(function () {
  var DEV = (typeof window !== "undefined") ? window.TS4RLS_DEV : undefined;
  var REPOS = DEV ? {
    engine:  DEV.repos.engine + "/CHANGELOG.md",
    website: DEV.repos.website + "/CHANGELOG.md"
  } : {
    engine:  "https://raw.githubusercontent.com/TS4RLS/Engine/main/CHANGELOG.md",
    website: "https://raw.githubusercontent.com/TS4RLS/Website/main/CHANGELOG.md"
  };
